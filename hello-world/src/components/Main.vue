            ...
            usersArr: [
                {
                    ...
                    userEmail: this.userEmail = JSON.parse(localStorage.getItem('email')),
                    userPhone: this.userPhone = JSON.parse(localStorage.getItem('tel')),
                    userResult: this.userResult = JSON.parse(localStorage.getItem('results')),
                },
            ],
        }
    },
...
td {
    border: solid 1px rgba(192, 192, 192, 0);
